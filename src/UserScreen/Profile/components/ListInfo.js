...
const ListInfo = ({ info, navigation, logout }) => {
  console.log("====================================");
  console.log(info);
  console.log("====================================");
  return (
      ...
      <View style={styles.infoConatiner}>
        <View style={styles.infoHeaderContainer}>
          ...
          <TouchableHighlight
            ...
            onPress={() => logout()}
          >
            <Ionicons name="ios-log-in" color={"#FFF"} size={20} />
          </TouchableHighlight>
        </View>
          ...
          <ScrollView>
            ...
            <View style={styles.infoItem}>
              ...
              <Text style={styles.textInfo}>
                {info.info.gender ? info.info.gender : "Khong ton tai"}
              </Text>
            </View>
            <View style={styles.infoItem}>
              <Entypo name="address" color={"#0288D1"} size={25} />
              <Text style={styles.textInfo}>
                {info.info.address || "khong co thong tin"}
              </Text>
            </View>
            <View style={styles.infoItem}>
