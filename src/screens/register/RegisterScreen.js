...
class Register extends Component {
  ...
  _checkVisible() {
    ...
    if (this.state.fullname.length > 1 && this.state.email.length > 1 && this.state.phone.length > 1 && this.state.password.length > 1 && this.state.confirmpassword.length > 1) {
      this.setState({
  ...
  _handlerSubmit() {
    if (this._validateEmail(this.state.email) && this._validatePhone(this.state.phone)) {
